...
// Delete Array row for the index and move elements up
	    public void deleteIndex(int index){
	    	if(index < arraySize){
// Overwrite the value for the supplied index and then keep overwriting every index that follows
...
//
//// i starts at the end of the Array As it is decremented all indexes greater then they are sorted
//	    	
